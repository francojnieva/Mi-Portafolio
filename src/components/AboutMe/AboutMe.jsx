...
const AboutMe = () => {
    return (
        <section className='font-medium -mt-40 pb-3 text-lg space-y-6 text-[#808080] px-6 lg:pb-28 lg:w-[85%] lg:mx-auto lg:px-14 lg:-mt-32 lg:text-xl'>
            <p>Soy<span className=' text-[#55bffd] font-bold'> Franco Javier Nieva </span> y me apasiona el mundo de la tecnología, especialmente el desarrollo web Front End.</p>
